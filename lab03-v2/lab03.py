...
def main():
    ...
    parser.add_argument("--number_representation", type=str, choices=["binary", "real"], default="binary") # binary or real
    ...
    with open("results1.txt", "w") as file:
        ...
        if args.number_representation == "binary" and args.test_function == 1:
            ...
            while evaluate_t1.cost < MAX_COST:
                for i in range(100):
                    ...
                    file.write(f"{real_values} {cur_eval}\n")
                k += 1
                T = T_schedule_t1(T0=1, Tn=0.1, n = 99, k=k)
     ...
     # Binary representation and evaluate_t2
            ...
            real_values = tuple(map(lambda xi: float(bin2real(xi, NUM_RANGE_t2)), x))
            file.write(f"{real_values} {cur_eval}\n")
            ...
            while evaluate_t2.cost < MAX_COST:
                ...
                for i in range(100):
                    ...
                    file.write(f"{real_values} {cur_eval}\n")
                k += 1
                T = T_schedule_t2(T0=1, Tn=0.22, n = 99, k=k)
        ...
        # Real representation and evaluate_t1
            ...
            while evaluate_t1.cost < MAX_COST:
                ...
                for i in range(100):
                    ...
                    file.write(f"{real_values} {cur_eval}\n")
                k += 1
                T = T_schedule_t1(T0=1, Tn=0.22, n = 99, k=k)
